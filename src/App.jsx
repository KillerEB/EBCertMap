...
const DOMAINS = [
  { id:"offensive",              label:"Offensive Security",         short:"Offensive",   color:"#f87171", count:101,description:"Penetration testing, exploit development, red teaming, adversary simulation, and offensive security research across networks, applications, and systems." },
  { id:"dfir",                   label:"Digital Forensics & IR",     short:"DFIR",        color:"#fb923c", count:49, description:"Digital forensics, memory and mobile forensics, malware analysis, incident response, threat hunting, and cloud forensics across enterprise and cloud environments." },
  ...
  { id:"threat_intelligence",    label:"Threat Intelligence",        short:"CTI",         color:"#f59e0b", count:11, description:"Cyber threat intelligence analysis, threat actor profiling, TTP analysis, IOC management, and intelligence platform operations." },
